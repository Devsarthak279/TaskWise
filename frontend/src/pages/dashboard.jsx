...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchTasksCount = async () => {
      try {
        const response = await fetch("http://localhost:3000/tasks/count");
    ...
    const fetchCompletedTasksCount = async () => {
      try {
        const response = await fetch("http://localhost:3000/tasks/completed/count");
        const data = await response.json();
    ...
    const fetchInProgressTasksCount = async () => {
      try {
        const response = await fetch("http://localhost:3000/tasks/inprogress/count");
        const data = await response.json();
    ...
    const fetchTodosCount = async () => {
      try {
        const response = await fetch("http://localhost:3000/tasks/todos/count");
        const data = await response.json();
