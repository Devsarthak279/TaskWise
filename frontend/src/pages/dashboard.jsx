...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchTasksCount = async () => {
      try {
        const response = await fetch("https://taskwise-mh3g.onrender.com/tasks/count");
    ...
    const fetchCompletedTasksCount = async () => {
      try {
        const response = await fetch("https://taskwise-mh3g.onrender.com/tasks/completed/count");
        const data = await response.json();
    ...
    const fetchInProgressTasksCount = async () => {
      try {
        const response = await fetch("https://taskwise-mh3g.onrender.com/tasks/inprogress/count");
        const data = await response.json();
    ...
    const fetchTodosCount = async () => {
      try {
        const response = await fetch("https://taskwise-mh3g.onrender.com/tasks/todos/count");
        const data = await response.json();
